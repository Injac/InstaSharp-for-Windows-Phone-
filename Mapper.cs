...
namespace InstaSharp {
    class Mapper {
                                    ...
                                    if (json != null)
                                    {
                                        if (json[mapsTo] != null)
                                        {
                                            ...
                                            if (prop.PropertyType == typeof(DateTime))
                                                ...
                                                prop.SetValue(instance, Convert.ChangeType(json[mapsTo].ToString(), prop.PropertyType, CultureInfo.CurrentCulture), null);
                                        }
                                    }
                                    break;
                            }
        ...
        private static void SetPropertyValue(PropertyInfo prop, object instance, object value) {
            prop.SetValue(instance, Convert.ChangeType(value, prop.PropertyType,CultureInfo.CurrentCulture), null);
        }
    }
}
